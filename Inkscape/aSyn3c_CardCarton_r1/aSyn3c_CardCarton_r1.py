...
##    This plugin can be sourced from a git repository
##    on a different file system from the user profile;
##    here is how it is done:
##
##    cmd /c mklink /d ^
##  "C:\Users\%USER%\AppData\Roaming\inkscape\extensions\aSyn3c_CardCarton_r1" ^
##  "M:\file\revision\github.com\sync3x\CardCarton\Inkscape\aSyn3c_CardCarton_r1"
##
##      [ you will be required to run your command prompt as administrator. ]
##      ( the caret ^ is a line continuation character in a batch file. )
##
##

from __future__ import \
    division  # python 3 provides true division by default #https://peps.python.org/pep-0238/ # was found in a scribus script

idstamping = {'net.asyn3c.', 'inkscape.carton.', 'rev.0001.', 'ver.2023.11.12'}
...
class aSyn3c91(_inx.Effect):
                            ...
                            for list03 in list02:
                                ...
                                if not isinstance(list03, list):
                                    ...
                                    if __.debug[0]: _inx.utils.debug('<3>')
                                        ...
                                        len(list03) == 1):  # One flag only; it will apply to all remaining elements of the brace.
                                    ...
                                    if __.debug[0]:
                                        _inx.utils.debug('<3= ' + ','.join(map(str, list03)) + ' =3> |' +
                                                         str(flag_4) + '|' + str(flag_3) + '|' + str(
                                            flag_2) + '|-' + str(flag_1) + '-|=' + str(flag_0) + '=|')
                                    if (  # b_plot=(
                                            ...
                                            ((flag_0 & 0x1800) & (0x0800) > 0 and (
                                                    (flag_0 & 0x0066) & (0x0002 if __.z1carton['Lidd'][
                                                                                       item00] == 'c-lock' else 0x0000) > 0 or  # clip-lock
                                                    (flag_0 & 0x0066) & (0x0004 if __.z1carton['Lidd'][
                                                                                       item00] == 'p-lock' else 0x0000) > 0 or  # push-lock
                                                    (flag_0 & 0x0066) & (0x0006 if __.z1carton['Lidd'][
                                                                                       item00] == 't-lock' else 0x0000) > 0 or  # tear-lock
                                                    False
                                            ) and (flag_0 & 0x2000) == (
                                             0x0000 if __.z1carton['LiddOrient'][item00] == 'F' else 0x2000)) or
                                            ((flag_0 & 0x1800) & (0x1000) > 0 and (
                                                    (flag_0 & 0x0066) & (0x0002 if __.z1carton['Base'][
                                                                                       item00] == 'c-lock' else 0x0000) > 0 or  # clip-lock
                                                    (flag_0 & 0x0066) & (0x0004 if __.z1carton['Base'][
                                                                                       item00] == 'p-lock' else 0x0000) > 0 or  # push-lock
                                                    (flag_0 & 0x0066) & (0x0006 if __.z1carton['Base'][
                                                                                       item00] == 't-lock' else 0x0000) > 0 or  # tear-lock
                                                    (flag_0 & 0x0066) & (0x0020 if __.z1carton['Base'][
                                                                                       item00] == 'a-lock' else 0x0000) > 0 or  # auto-lock
                                                    (flag_0 & 0x0066) & (0x0040 if __.z1carton['Base'][
                                                                                       item00] == 'f-lock' else 0x0000) > 0 or  # full-lock
                                                    False
                                            ) and (flag_0 & 0x2000) == (
                                             0x0000 if __.z1carton['BaseOrient'][item00] == 'F' else 0x2000)) or
                                            False
                                    ) and (
                                            (((flag_0 & 0x01) == 0x00) if __.z0job0[
                                                                              'fullcube'] == 'half' else True) and  # no to full-cube only segments in a half cube
                                            (((flag_0 & 0x08) == 0x00) if __.z0job0[
                                                                              'fullcube'] == 'full' else True) and  # no to half-cube only segments in a full cube
                                        ...
                                        if len(list03) == 2:  # Without paramaters, usually, this is a path terminator; an SVG 'z'.
                                            xml0 += list03[1] + ' '
                                                ...
                                                list03) >= 3:  # With parameters, we accomodate the distribution of those below.
                                            ...
                                            if list03[1] == 'M' or list03[1] == 'L' or list03[1] == 'C':
                                                ...
                                                if __.debug[2] and list03[1] == 'M': # reduce labels to only the first move of each path
                                                    _this_move = [float(list03[2 + circleoffset]),
                                                                  float(list03[3 + circleoffset])]
                                                    _text_plot = _this_move
                                                    _found_count = 0
                                                    for _that_move in __._list_move:
                                                        if (
                                                                (_this_move[0] >= _that_move[0] - 4 and _this_move[0] <=
                                                                 _that_move[0] + 25) and
                                                                (_this_move[1] >= _that_move[1] - 3 and _this_move[1] <=
                                                                 _that_move[1] + ((_found_count + 3) * 2))
                                                        ):
                                                            _found_count += 1
                                                            if (_this_move[1] >= _that_move[1] - 2 and _this_move[1] <=
                                                                    _that_move[1] + 4):
                                                                _found_count += 1
                                                            if __.debug[0] or __.debug[1]: _inx.utils.debug(
                                                                ['<>', _text_plot, 'near', _that_move, 'iter',
                                                                 _found_count])
                                                            # break # must go through complete list!
                                                    _text_plot[1] += ((_found_count) * 2)
                                                    if _found_count == 0:
                                                        if __.debug[0] or __.debug[1]: _inx.utils.debug(
                                                            ['==', _this_move, _last_move])
                                                    _stye_ = __._stylesheet_['q_diagtype']
                                                    _stye_['fill'] = __._stylesheet_[style0][
                                                        'stroke']  # I want the font colour to match the current fold/chop stroke
                                                    _stye_[
                                                        'stroke'] = '#000000'  # It is hard to see the lighter colours against a white page.
                                                    attribs = {
                                                        'style': str(_inx.Style(_stye_)),
                                                        _inx.addNS('label', 'inkscape'): '{0:04X}'.format(
                                                            movecounting) + '--' + ("T0" if list03[
                                                                                                1] == 'M' else "Tn--" + '{0:04X}'.format(
                                                            linecounting)),
                                                    ...
                                                    text.text = 'X{0:+05.2f}, Y{1:+05.2f}; {2:04X}.'.format(
                                                        float(list03[2 + circleoffset]),
                                                        float(list03[3 + circleoffset]), movecounting)
                                                    _doug_.add(text)
                                                    _last_move = [float(list03[2 + circleoffset]),
                                                                  float(list03[3 + circleoffset])]
                                                ...
                                                if __.debug[3]:
                                                    ...
                                                    _stye_['stroke'] = __._stylesheet_[style0][
                                                        'stroke']  # I want the diagnostic stroke to match the current fold/chop stroke
                                                    attribs = {
                                                        'style': str(_inx.Style(_stye_)),
                                                        _inx.addNS('label', 'inkscape'): '{0:04X}'.format(
                                                            movecounting) + '--' + ("Move" if list03[
                                                                                                  1] == 'M' else "Plot--" + '{0:04X}'.format(
                                                            linecounting)),
    ...
    def offect_1(__):  # 1 piece
        for iz in range(len(__.z1carton['Enable'])):
            ...
            ## supplementary co-ordinates for beizer curves.
            ...
            __._geom_ = {
                ...
                'q_hang_pin': [
                    [02.0, 06.0, 08.0, 10.0, 10.0, 08.0, 06.0, 02.0, -02.0, -06.0, -08.0, -10.0, -10.0, -08.0, -06.0,
                     -02.0],
            ...
            __.z1carton['GRID'][iz][1] = [__.z1carton['GRID'][iz][0][0] + __._['q_tab_glue_diameter'],
                                          __.z1carton['GRID'][iz][0][1] + __._['q_tab_lid_diameter']]  # Real Tab.
            __.z1carton['GRID'][iz][2] = [__.z1carton['GRID'][iz][1][0] + __.z1carton['Leng'][iz],
                                          __.z1carton['GRID'][iz][1][1] + __.z1carton['Widt'][iz] + __._[
                                              'q_crease_lid_hinge_outset']]
            __.z1carton['GRID'][iz][3] = [__.z1carton['GRID'][iz][2][0] + __.z1carton['Widt'][iz],
                                          __.z1carton['GRID'][iz][2][1] + (__.z1carton['Heig'][iz] / 2)]
            __.z1carton['GRID'][iz][4] = [__.z1carton['GRID'][iz][3][0] + __.z1carton['Leng'][iz],
                                          __.z1carton['GRID'][iz][2][1] + __.z1carton['Heig'][iz]]
            __.z1carton['GRID'][iz][5] = [
                __.z1carton['GRID'][iz][4][0] + __.z1carton['Widt'][iz] - __._['q_tab_glue_seam_reduction'],
                __.z1carton['GRID'][iz][4][1] + __.z1carton['Widt'][iz] + __._['q_crease_lid_hinge_outset']]
            __.z1carton['GRID'][iz][6] = [__.z1carton['GRID'][iz][5][0] + __._['q_tab_glue_diameter'],
                                          __.z1carton['GRID'][iz][5][1] + __._['q_tab_lid_diameter']]  # Phantom Tab!
            # last one is the total size as flat piece, without margin / point of origin
            __.z1carton['GRID'][iz][7] = [__.z1carton['GRID'][iz][5][0] - __.z1carton['GRID'][iz][0][0],
                                          __.z1carton['GRID'][iz][6][1] - __.z1carton['GRID'][iz][0][1]]
            ...
            __.z1carton['Window'][iz]['centre'] = {
                'x': [
                    ...
                    __.z1carton['GRID'][iz][1][0] + (__.z1carton['Leng'][iz] / 2),
                    __.z1carton['GRID'][iz][2][0] + (__.z1carton['Widt'][iz] / 2),
                    __.z1carton['GRID'][iz][3][0] + (__.z1carton['Leng'][iz] / 2),
                    __.z1carton['GRID'][iz][4][0] + (__.z1carton['Widt'][iz] / 2),
            ...
            for qZ in range(len(__.z1carton['GridInsert'][iz])):  # (__.z1carton['GridInsert'][iz].buffer_info()[1]):
                ...
                if qZ > 0:
                    __.z1carton['GridInsert'][iz][qZ][0] = __.z1carton['GridInsert'][iz][qZ - 1][0] + \
                                                           __.z1carton['Insert'][iz]['Li'][0] + __.z0job0['offset'][1][
                                                               0]
            ...
            ##
            ## hangsell extension
            _hangoffset_ = (2 if __.z1carton['LiddOrient'][
                                     iz] == 'F' else 0)  # the hangtabb shall be positioned opposing the lid at all times.
            ##
            ...
            _softcarton_ = {
                ...
                'common': {
                    ...
                    'glue-tab': {
                        ...
                        'L': [
                            [0x0000],
                            # This is the left side of the carton. ( Begin with a 'M'ove because current flap order introduces an unwanted line. )
                            [0, 'M', __.z1carton['GRID'][iz][1][0], __.z1carton['GRID'][iz][4][1], ],
                            [0, 'L', __.z1carton['GRID'][iz][0][0],
                             __.z1carton['GRID'][iz][4][1] - __._['q_tab_glue_taper'], ],
                            [0, 'L', __.z1carton['GRID'][iz][0][0],
                             __.z1carton['GRID'][iz][2][1] + __._['q_tab_glue_taper'], ],
                            [0, 'L', __.z1carton['GRID'][iz][1][0], __.z1carton['GRID'][iz][2][1], ],
                            # broken path, first point closure
                            [16, 'z', ],
                            # 16=deprecated; close all our closed paths; half and full cube, any lid and base selection.
                        ],
                        'R': [
                            [0x0001],
                            # This is the right side of the carton. In one-piece production this phantom tab does not exist!
                            [0, 'M', __.z1carton['GRID'][iz][5][0], __.z1carton['GRID'][iz][2][1], ],
                            [0, 'L', __.z1carton['GRID'][iz][6][0],
                             __.z1carton['GRID'][iz][2][1] + __._['q_tab_glue_taper'], ],
                            [0, 'L', __.z1carton['GRID'][iz][6][0],
                             __.z1carton['GRID'][iz][4][1] - __._['q_tab_glue_taper'], ],
                    ...
                    'hang-tab': {
                        ...
                        'outer': [  ## hangtabb (the hanging tab)
                            [(0x0903 if __.z1carton['LiddOrient'][iz] == 'F' else 0x2903)],
                            # the remainder of this brace will be flagged as lid-geometry.
                            [0, 'L', __.z1carton['GRID'][iz][_hangoffset_ + 1][0] + __._geom_['q_hang_tab'][0][0],
                             __.z1carton['GRID'][iz][2][1] - __._geom_['q_hang_tab'][1][0], ],
                            [0, 'L', __.z1carton['GRID'][iz][_hangoffset_ + 1][0] + __._geom_['q_hang_tab'][0][1],
                             __.z1carton['GRID'][iz][2][1] - __._geom_['q_hang_tab'][1][1] - __._[
                                 'q_hang_tab_height'], ],
                            [0, 'L', __.z1carton['GRID'][iz][_hangoffset_ + 1][0] + __._geom_['q_hang_tab'][0][2],
                             __.z1carton['GRID'][iz][2][1] - __._geom_['q_hang_tab'][1][2] - __._[
                                 'q_hang_tab_height'], ],
                            [0, 'L', __.z1carton['GRID'][iz][_hangoffset_ + 1][0] + __._geom_['q_hang_tab'][0][3],
                             __.z1carton['GRID'][iz][2][1] - __._geom_['q_hang_tab'][1][3] - __._[
                                 'q_hang_tab_height'], ],
                            [0, 'L', __.z1carton['GRID'][iz][_hangoffset_ + 2][0] - __._geom_['q_hang_tab'][0][3],
                             __.z1carton['GRID'][iz][2][1] - __._geom_['q_hang_tab'][1][3] - __._[
                                 'q_hang_tab_height'], ],
                            [0, 'L', __.z1carton['GRID'][iz][_hangoffset_ + 2][0] - __._geom_['q_hang_tab'][0][2],
                             __.z1carton['GRID'][iz][2][1] - __._geom_['q_hang_tab'][1][2] - __._[
                                 'q_hang_tab_height'], ],
                            [0, 'L', __.z1carton['GRID'][iz][_hangoffset_ + 2][0] - __._geom_['q_hang_tab'][0][1],
                             __.z1carton['GRID'][iz][2][1] - __._geom_['q_hang_tab'][1][1] - __._[
                                 'q_hang_tab_height'], ],
                            [0, 'L', __.z1carton['GRID'][iz][_hangoffset_ + 2][0] - __._geom_['q_hang_tab'][0][0],
                             __.z1carton['GRID'][iz][2][1] - __._geom_['q_hang_tab'][1][0], ],
                        ],
            ...
            def _func_flap_base(flag, number, updown):
                ...
                offset = [0,
                          0]  # X is useful; Y not so much, until I can use a loop to reverse the order of the plotting below.
                ...
                _art = [
                    ...
                    [0, 'M', __.z1carton['GRID'][iz][offset[0] + 1][0] + __._['q_tab_lid_reduce'],
                     __.z1carton['GRID'][iz][offset[1] + 1][1], ],
                    [0, 'C',
                     (__.z1carton['GRID'][iz][offset[0] + 1][0]) + __._['q_tab_lid_reduce'],
                     (__.z1carton['GRID'][iz][offset[1] + 1][1]) - (
                                 __._['q_tab_lid_diameter'] * __._['q_tab_lid_curve_diameter']),
                     (__.z1carton['GRID'][iz][offset[0] + 1][0]) + __._['q_tab_lid_reduce'] + (
                                 __._['q_tab_lid_taper'] * __._['q_tab_lid_curve_taper']),
                     (__.z1carton['GRID'][iz][offset[1] + 0][1]),
                     (__.z1carton['GRID'][iz][offset[0] + 1][0]) + __._['q_tab_lid_reduce'] + (__._['q_tab_lid_taper']),
                     (__.z1carton['GRID'][iz][offset[1] + 0][1]), ],
                    [0, 'L',
                     __.z1carton['GRID'][iz][offset[0] + 2][0] - __._['q_tab_lid_reduce'] - __._['q_tab_lid_taper'],
                     __.z1carton['GRID'][iz][offset[1] + 0][1], ],
                    [0, 'C',
                     (__.z1carton['GRID'][iz][offset[0] + 2][0]) - __._['q_tab_lid_reduce'] - (
                                 __._['q_tab_lid_taper'] * __._['q_tab_lid_curve_taper']),
                     (__.z1carton['GRID'][iz][offset[1] + 0][1]),
                     (__.z1carton['GRID'][iz][offset[0] + 2][0]) - __._['q_tab_lid_reduce'],
                     (__.z1carton['GRID'][iz][offset[1] + 1][1]) - (
                    ...
                    [0, 'M', __.z1carton['GRID'][iz][offset[0] + 2][0] - __._['q_tab_lid_reduce'],
                     __.z1carton['GRID'][iz][offset[1] + 5][1], ],
                    [0, 'C',
                     (__.z1carton['GRID'][iz][offset[0] + 2][0]) - __._['q_tab_lid_reduce'],
                     (__.z1carton['GRID'][iz][offset[1] + 5][1]) + (
                             __._['q_tab_lid_diameter'] * __._['q_tab_lid_curve_diameter']),
                     (__.z1carton['GRID'][iz][offset[0] + 2][0]) - __._['q_tab_lid_reduce'] - (
                                 __._['q_tab_lid_taper'] * __._['q_tab_lid_curve_taper']),
                     (__.z1carton['GRID'][iz][offset[1] + 5][1]) + (__._['q_tab_lid_diameter']),
                     (__.z1carton['GRID'][iz][offset[0] + 2][0]) - __._['q_tab_lid_reduce'] - (__._['q_tab_lid_taper']),
                     (__.z1carton['GRID'][iz][offset[1] + 5][1]) + (__._['q_tab_lid_diameter']), ],
                    [0, 'L',
                     __.z1carton['GRID'][iz][offset[0] + 1][0] + __._['q_tab_lid_reduce'] + __._['q_tab_lid_taper'],
            ...
            _softcarton_['cliplock'] = {
                ...
                'inner-flap': {
                    # These had to be split into two parts because of my method of separating flush and relief entry relative to lid and base.

                    'A1i1': [
                        # Begin path as a relief or flush entry into the left side tab. This is for same side opening lids.
                        [0x0802],
                        [0, 'M', __.z1carton['GRID'][iz][2][0] + __._geom_['q_flap']['inn']['x'][0],
                         __.z1carton['GRID'][iz][2][1] - __._geom_['q_flap']['inn']['y'][0], ],
                        [0, 'L', __.z1carton['GRID'][iz][2][0] + __._['q_tab_dust_seam_reduction'] +
                         __._geom_['q_flap']['inn']['x'][1],
                         __.z1carton['GRID'][iz][2][1] - __._geom_['q_flap']['inn']['y'][1], ],
                        [0, 'L', __.z1carton['GRID'][iz][2][0] + __._['q_tab_dust_seam_reduction'] +
                         __._geom_['q_flap']['inn']['x'][2],
                        ...
                        [0x0802],
                        [0, 'M', __.z1carton['GRID'][iz][2][0],
                         __.z1carton['GRID'][iz][2][1] - __.z1carton['FlapHeight'][iz], ],
                    ...
                    'A1o1': [  # Continue to opposite end of this shape which is common to both flush and relief tabs.
                        [0x0802],
                        [0, 'L', __.z1carton['GRID'][iz][3][0] - __._['q_tab_dust_seam_reduction'] -
                         __._geom_['q_flap']['out']['x'][3],
                         __.z1carton['GRID'][iz][2][1] + __._geom_['q_flap']['out']['y'][3] - __.z1carton['FlapHeight'][
                             iz], ],
                        [0, 'L', __.z1carton['GRID'][iz][3][0] - __._['q_tab_dust_seam_reduction'] -
                         __._geom_['q_flap']['out']['x'][2],
                         __.z1carton['GRID'][iz][2][1] - __._geom_['q_flap']['out']['y'][2], ],
                        [0, 'L', __.z1carton['GRID'][iz][3][0] - __._['q_tab_dust_seam_reduction'] -
                         __._geom_['q_flap']['out']['x'][1],
                         __.z1carton['GRID'][iz][2][1] - __._geom_['q_flap']['out']['y'][1], ],
                        [0, 'L', __.z1carton['GRID'][iz][3][0] - __._['q_tab_dust_seam_reduction'] -
                         __._geom_['q_flap']['out']['x'][0],
                         __.z1carton['GRID'][iz][2][1] - __._geom_['q_flap']['out']['y'][0], ],
                    ...
                    'A1i2': [  # Begin path common to both flush and relief tabs
                        ...
                        [0, 'L', __.z1carton['GRID'][iz][4][0] + __._['q_tab_dust_seam_reduction'] +
                         __._geom_['q_flap']['out']['x'][0],
                         __.z1carton['GRID'][iz][2][1] - __._geom_['q_flap']['out']['y'][0], ],
                        [0, 'L', __.z1carton['GRID'][iz][4][0] + __._['q_tab_dust_seam_reduction'] +
                         __._geom_['q_flap']['out']['x'][1],
                    ...
                    'A1o2': [
                        # Continue to opposite end of this shape in a manner specific to either relief or flush tabs.
                        [0x0803],
                        [0, 'L', __.z1carton['GRID'][iz][5][0] - __._geom_['q_flap']['inn']['x'][2],
                         __.z1carton['GRID'][iz][2][1] + __._geom_['q_flap']['inn']['y'][3] - __.z1carton['FlapHeight'][
                             iz], ],
                        [0, 'L', __.z1carton['GRID'][iz][5][0] - __._geom_['q_flap']['inn']['x'][2],
                         __.z1carton['GRID'][iz][2][1] - __._geom_['q_flap']['inn']['y'][2], ],
                        [0, 'L', __.z1carton['GRID'][iz][5][0] - __._geom_['q_flap']['inn']['x'][1],
                         __.z1carton['GRID'][iz][2][1] - __._geom_['q_flap']['inn']['y'][1], ],
                        [0, 'L', __.z1carton['GRID'][iz][5][0] - __._geom_['q_flap']['inn']['x'][0],
                         __.z1carton['GRID'][iz][2][1] - __._geom_['q_flap']['inn']['y'][0], ],
                        [0, 'L', __.z1carton['GRID'][iz][5][0], __.z1carton['GRID'][iz][2][1], ],
                    ] if __.z1carton['Flap'][iz] == 1 else [
                        [0x0803],
                        [0, 'L', __.z1carton['GRID'][iz][5][0],
                         __.z1carton['GRID'][iz][2][1] - __.z1carton['FlapHeight'][iz], ],
                        [0, 'L', __.z1carton['GRID'][iz][5][0], __.z1carton['GRID'][iz][2][1], ],
                    ],

                    'A2i1': [
                        # This is for reverse side opening lids. The shape is mirrored to have the curve align to the direction of the lid tab.
                        [0x2802],
                        [0, 'M', __.z1carton['GRID'][iz][2][0] + __._['q_tab_dust_seam_reduction'] +
                         __._geom_['q_flap']['out']['x'][0],
                         __.z1carton['GRID'][iz][2][1] - __._geom_['q_flap']['inn']['y'][0], ],
                        [0, 'L', __.z1carton['GRID'][iz][2][0] + __._['q_tab_dust_seam_reduction'] +
                         __._geom_['q_flap']['out']['x'][1],
                    ...
                    'A2o1': [
                        ...
                        [0, 'L', __.z1carton['GRID'][iz][3][0] - __._geom_['q_flap']['inn']['x'][1],
                         __.z1carton['GRID'][iz][2][1] - __._geom_['q_flap']['out']['y'][1], ],
                        [0, 'L', __.z1carton['GRID'][iz][3][0] - __._geom_['q_flap']['inn']['x'][0],
                         __.z1carton['GRID'][iz][2][1] - __._geom_['q_flap']['out']['y'][0], ],
                        [0, 'L', __.z1carton['GRID'][iz][3][0], __.z1carton['GRID'][iz][2][1], ],
                    ] if __.z1carton['Flap'][iz] == 1 else [
                        [0x2802],
                        # [ 0 , 'L', __.z1carton['GRID'][iz][2][0], __.z1carton['GRID'][iz][2][1], ],
                        [0, 'L', __.z1carton['GRID'][iz][3][0],
                         __.z1carton['GRID'][iz][2][1] - __.z1carton['FlapHeight'][iz], ],
                        # [ 0 , 'L', __.z1carton['GRID'][iz][3][0], __.z1carton['GRID'][iz][2][1], ],
                        # bug: The 'Move' commencing this flap once drew a line from the previous 'Move' commencing the lid; I do not know why.
                    ],
                    ...
                    'A2i2': [
                        [0x2803],
                        [0, 'M', __.z1carton['GRID'][iz][4][0], __.z1carton['GRID'][iz][2][1], ],
                        [0, 'L', __.z1carton['GRID'][iz][4][0] + __._geom_['q_flap']['inn']['x'][0],
                         __.z1carton['GRID'][iz][2][1] - __._geom_['q_flap']['out']['y'][0], ],
                        [0, 'L', __.z1carton['GRID'][iz][4][0] + __._geom_['q_flap']['inn']['x'][1],
                         __.z1carton['GRID'][iz][2][1] - __._geom_['q_flap']['out']['y'][1], ],
                        [0, 'L', __.z1carton['GRID'][iz][4][0] + __._geom_['q_flap']['inn']['x'][2],
                         __.z1carton['GRID'][iz][2][1] - __._geom_['q_flap']['out']['y'][2], ],
                        [0, 'L', __.z1carton['GRID'][iz][4][0] + __._geom_['q_flap']['inn']['x'][2],
                         __.z1carton['GRID'][iz][2][1] + __._geom_['q_flap']['out']['y'][3] - __.z1carton['FlapHeight'][
                             iz], ],
                        ...
                        [0x2803],
                        [0, 'M', __.z1carton['GRID'][iz][4][0],
                         __.z1carton['GRID'][iz][2][1] - __.z1carton['FlapHeight'][iz], ],
                    ],
                    'A2o2': [
                        [0x2803],
                        [0, 'L', __.z1carton['GRID'][iz][5][0] - __._geom_['q_flap']['out']['x'][3],
                         __.z1carton['GRID'][iz][2][1] + __._geom_['q_flap']['inn']['y'][3] - __.z1carton['FlapHeight'][
                             iz], ],
                        [0, 'L', __.z1carton['GRID'][iz][5][0] - __._geom_['q_flap']['out']['x'][2],
                         __.z1carton['GRID'][iz][2][1] - __._geom_['q_flap']['inn']['y'][2], ],
                        [0, 'L', __.z1carton['GRID'][iz][5][0] - __._geom_['q_flap']['out']['x'][1],
                         __.z1carton['GRID'][iz][2][1] - __._geom_['q_flap']['inn']['y'][1], ],
                        [0, 'L', __.z1carton['GRID'][iz][5][0] - __._geom_['q_flap']['out']['x'][0],
                         __.z1carton['GRID'][iz][2][1] - __._geom_['q_flap']['inn']['y'][0], ],
                        [0, 'L', __.z1carton['GRID'][iz][5][0], __.z1carton['GRID'][iz][2][1], ],
                    ],
                    ...
                    'B1i1': [
                        ...
                        [0, 'M', __.z1carton['GRID'][iz][5][0] - __._geom_['q_flap']['inn']['x'][0],
                         __.z1carton['GRID'][iz][4][1] + __._geom_['q_flap']['inn']['y'][0], ],
                        [0, 'L', __.z1carton['GRID'][iz][5][0] - __._geom_['q_flap']['inn']['x'][1],
                         __.z1carton['GRID'][iz][4][1] + __._geom_['q_flap']['inn']['y'][1], ],
                        [0, 'L', __.z1carton['GRID'][iz][5][0] - __._geom_['q_flap']['inn']['x'][2],
                         __.z1carton['GRID'][iz][4][1] + __._geom_['q_flap']['inn']['y'][2], ],
                        [0, 'L', __.z1carton['GRID'][iz][5][0] - __._geom_['q_flap']['inn']['x'][2],
                         __.z1carton['GRID'][iz][4][1] + __.z1carton['FlapHeight'][iz] -
                         __._geom_['q_flap']['inn']['y'][3], ],
                    ] if __.z1carton['Flap'][iz] == 1 else [
                        [0x1003],
                    ...
                    'B1o1': [
                        ...
                        [0, 'L', __.z1carton['GRID'][iz][4][0] + __._['q_tab_dust_seam_reduction'] +
                         __._geom_['q_flap']['out']['x'][3],
                         __.z1carton['GRID'][iz][4][1] + __.z1carton['FlapHeight'][iz] -
                         __._geom_['q_flap']['out']['y'][3], ],
                        [0, 'L', __.z1carton['GRID'][iz][4][0] + __._['q_tab_dust_seam_reduction'] +
                         __._geom_['q_flap']['out']['x'][2],
                         __.z1carton['GRID'][iz][4][1] + __._geom_['q_flap']['out']['y'][2], ],
                        [0, 'L', __.z1carton['GRID'][iz][4][0] + __._['q_tab_dust_seam_reduction'] +
                         __._geom_['q_flap']['out']['x'][1],
                         __.z1carton['GRID'][iz][4][1] + __._geom_['q_flap']['out']['y'][1], ],
                        [0, 'L', __.z1carton['GRID'][iz][4][0] + __._['q_tab_dust_seam_reduction'] +
                         __._geom_['q_flap']['out']['x'][0],
                         __.z1carton['GRID'][iz][4][1] + __._geom_['q_flap']['out']['y'][0], ],
                        [0, 'L', __.z1carton['GRID'][iz][4][0], __.z1carton['GRID'][iz][4][1], ],
                    ],

                    'B1i2': [
                        [0x1002],
                        [0, 'M', __.z1carton['GRID'][iz][3][0] - __._['q_tab_dust_seam_reduction'] -
                         __._geom_['q_flap']['out']['x'][0],
                         __.z1carton['GRID'][iz][4][1] + __._geom_['q_flap']['out']['y'][0], ],
                        [0, 'L', __.z1carton['GRID'][iz][3][0] - __._['q_tab_dust_seam_reduction'] -
                         __._geom_['q_flap']['out']['x'][1],
                    ...
                    'B1o2': [
                        ...
                        [0, 'L', __.z1carton['GRID'][iz][2][0] + __._['q_tab_dust_seam_reduction'] +
                         __._geom_['q_flap']['inn']['x'][1],
                         __.z1carton['GRID'][iz][4][1] + __._geom_['q_flap']['inn']['y'][1], ],
                        [0, 'L', __.z1carton['GRID'][iz][2][0] + __._geom_['q_flap']['inn']['x'][0],
                         __.z1carton['GRID'][iz][4][1] + __._geom_['q_flap']['inn']['y'][0], ],
                        [0, 'L', __.z1carton['GRID'][iz][2][0], __.z1carton['GRID'][iz][4][1], ],
                    ] if __.z1carton['Flap'][iz] == 1 else [
                        [0x1002],
                        [0, 'L', __.z1carton['GRID'][iz][2][0],
                         __.z1carton['GRID'][iz][4][1] + __.z1carton['FlapHeight'][iz], ],
                        # [ 0 , 'L', __.z1carton['GRID'][iz][2][0], __.z1carton['GRID'][iz][4][1], ],
                    ],
                    ...
                    'B2i1': [
                        ...
                        [0, 'M', __.z1carton['GRID'][iz][5][0] - __._geom_['q_flap']['out']['x'][0],
                         __.z1carton['GRID'][iz][4][1] + __._geom_['q_flap']['inn']['y'][0], ],
                        [0, 'L', __.z1carton['GRID'][iz][5][0] - __._geom_['q_flap']['out']['x'][1],
                         __.z1carton['GRID'][iz][4][1] + __._geom_['q_flap']['inn']['y'][1], ],
                        [0, 'L', __.z1carton['GRID'][iz][5][0] - __._geom_['q_flap']['out']['x'][2],
                    ...
                    'B2i2': [
                        [0x3002],
                        [0, 'M', __.z1carton['GRID'][iz][3][0] - __._geom_['q_flap']['inn']['x'][0],
                         __.z1carton['GRID'][iz][4][1] + __._geom_['q_flap']['out']['y'][0], ],
                        [0, 'L', __.z1carton['GRID'][iz][3][0] - __._geom_['q_flap']['inn']['x'][1],
                         __.z1carton['GRID'][iz][4][1] + __._geom_['q_flap']['out']['y'][1], ],
                        [0, 'L', __.z1carton['GRID'][iz][3][0] - __._geom_['q_flap']['inn']['x'][2],
            ...
            _softcarton_['pushlock'] = {
                ...
                'onepiece': {
                    ...
                    'forward': [
                        ...
                        [0, 'L', __.z1carton['GRID'][iz][5][0] - 0,
                         __.z1carton['GRID'][iz][4][1] + (__.z1carton['Leng'][iz] / 2), ],
                        [0, 'L', __.z1carton['GRID'][iz][5][0] - (__.z1carton['Widt'][iz] * 0.20),
                         __.z1carton['GRID'][iz][4][1] + (__.z1carton['Leng'][iz] / 2), ],
                        [0, 'L', __.z1carton['GRID'][iz][5][0] - (__.z1carton['Widt'][iz] * 0.20),
                         __.z1carton['GRID'][iz][4][1] + (__.z1carton['Leng'][iz] / 2) - __._['q_tab_glue_diameter'], ],
                        [0, 'L', __.z1carton['GRID'][iz][4][0] + 3, __.z1carton['GRID'][iz][4][1] + 3, ],

                        [0, 'L', __.z1carton['GRID'][iz][4][0], __.z1carton['GRID'][iz][4][1], ],

                        [0, 'L', __.z1carton['GRID'][iz][4][0] - (__.z1carton['Leng'][iz] * 0.10),
                         __.z1carton['GRID'][iz][4][1] + (__.z1carton['Widt'][iz] * 0.75), ],
                        [0, 'L', __.z1carton['GRID'][iz][4][0] - (__.z1carton['Leng'][iz] * 0.20),
                         __.z1carton['GRID'][iz][4][1] + (__.z1carton['Widt'][iz] * 0.75), ],
                        [0, 'L', __.z1carton['GRID'][iz][4][0] - (__.z1carton['Leng'][iz] * 0.20),
                         __.z1carton['GRID'][iz][4][1] + (__.z1carton['Widt'][iz] * 0.45), ],
                        [0, 'L', __.z1carton['GRID'][iz][3][0] + (__.z1carton['Leng'][iz] * 0.20),
                         __.z1carton['GRID'][iz][4][1] + (__.z1carton['Widt'][iz] * 0.45), ],
                        [0, 'L', __.z1carton['GRID'][iz][3][0] + (__.z1carton['Leng'][iz] * 0.20),
                         __.z1carton['GRID'][iz][4][1] + (__.z1carton['Widt'][iz] * 0.75), ],
                        [0, 'L', __.z1carton['GRID'][iz][3][0] + (__.z1carton['Leng'][iz] * 0.10),
                         __.z1carton['GRID'][iz][4][1] + (__.z1carton['Widt'][iz] * 0.75), ],

                        [0, 'L', __.z1carton['GRID'][iz][3][0], __.z1carton['GRID'][iz][4][1], ],

                        [0, 'L', __.z1carton['GRID'][iz][3][0] - 3, __.z1carton['GRID'][iz][4][1] + 3, ],
                        [0, 'L', __.z1carton['GRID'][iz][2][0] + (__.z1carton['Widt'][iz] * 0.20),
                         __.z1carton['GRID'][iz][4][1] + (__.z1carton['Leng'][iz] / 2) - __._['q_tab_glue_diameter'], ],
                        [0, 'L', __.z1carton['GRID'][iz][2][0] + (__.z1carton['Widt'][iz] * 0.20),
                         __.z1carton['GRID'][iz][4][1] + (__.z1carton['Leng'][iz] / 2), ],
                        [0, 'L', __.z1carton['GRID'][iz][2][0] + 0,
                         __.z1carton['GRID'][iz][4][1] + (__.z1carton['Leng'][iz] / 2), ],

                        [0, 'L', __.z1carton['GRID'][iz][2][0], __.z1carton['GRID'][iz][4][1], ],

                        [0, 'L', __.z1carton['GRID'][iz][2][0] - (__.z1carton['Leng'][iz] * 0.21),
                         __.z1carton['GRID'][iz][4][1] + (__.z1carton['Widt'][iz] * 0.45), ],
                        [0, 'L', __.z1carton['GRID'][iz][2][0] - (__.z1carton['Leng'][iz] * 0.21),
                         __.z1carton['GRID'][iz][4][1] + (__.z1carton['Widt'][iz] * 0.65), ],
                        [0, 'L', __.z1carton['GRID'][iz][2][0] - (__.z1carton['Leng'][iz] * 0.30),
                         __.z1carton['GRID'][iz][4][1] + (__.z1carton['Widt'][iz] * 0.85), ],
                        [0, 'L', __.z1carton['GRID'][iz][1][0] + (__.z1carton['Leng'][iz] * 0.30),
                         __.z1carton['GRID'][iz][4][1] + (__.z1carton['Widt'][iz] * 0.85), ],
                        [0, 'L', __.z1carton['GRID'][iz][1][0] + (__.z1carton['Leng'][iz] * 0.21),
                         __.z1carton['GRID'][iz][4][1] + (__.z1carton['Widt'][iz] * 0.65), ],
                        [0, 'L', __.z1carton['GRID'][iz][1][0] + (__.z1carton['Leng'][iz] * 0.21),
                         __.z1carton['GRID'][iz][4][1] + (__.z1carton['Widt'][iz] * 0.45), ],
                    ...
                    'reverse': [
                        ...
                        [0, 'L', __.z1carton['GRID'][iz][5][0] - __._['q_tab_glue_diameter'],
                         __.z1carton['GRID'][iz][4][1] + (__.z1carton['Leng'][iz] / 2), ],
                        [0, 'L',
                         __.z1carton['GRID'][iz][5][0] - (__.z1carton['Widt'][iz] / 3) - __._['q_tab_glue_diameter'],
                         __.z1carton['GRID'][iz][4][1] + (__.z1carton['Leng'][iz] / 2), ],
                        [0, 'L',
                         __.z1carton['GRID'][iz][5][0] - (__.z1carton['Widt'][iz] / 3) - __._['q_tab_glue_diameter'],
                         __.z1carton['GRID'][iz][4][1] + (__.z1carton['Leng'][iz] / 2) - __._['q_tab_glue_diameter'], ],
                        ...
                        [0, 'L', __.z1carton['GRID'][iz][4][0] - __._['q_tab_glue_diameter'],
                         __.z1carton['GRID'][iz][4][1] + __._['q_tab_glue_diameter'], ],
                        [0, 'L', __.z1carton['GRID'][iz][4][0] - __._['q_tab_glue_diameter'],
                         __.z1carton['GRID'][iz][4][1] + __._['q_tab_glue_diameter'] + 6, ],
                        [0, 'L', __.z1carton['GRID'][iz][4][0] - __._['q_tab_glue_diameter'] - 4,
                         __.z1carton['GRID'][iz][4][1] + __._['q_tab_glue_diameter'] + 10, ],
                        [0, 'L', __.z1carton['GRID'][iz][3][0] + __._['q_tab_glue_diameter'] + 4,
                         __.z1carton['GRID'][iz][4][1] + __._['q_tab_glue_diameter'] + 10, ],
                        [0, 'L', __.z1carton['GRID'][iz][3][0] + __._['q_tab_glue_diameter'],
                         __.z1carton['GRID'][iz][4][1] + __._['q_tab_glue_diameter'] + 6, ],
                        [0, 'L', __.z1carton['GRID'][iz][3][0] + __._['q_tab_glue_diameter'],
                         __.z1carton['GRID'][iz][4][1] + __._['q_tab_glue_diameter'], ],
                        ...
                        [0, 'L', __.z1carton['GRID'][iz][3][0] - 3, __.z1carton['GRID'][iz][4][1] + 3, ],
                        [0, 'L',
                         __.z1carton['GRID'][iz][2][0] + (__.z1carton['Widt'][iz] / 3) + __._['q_tab_glue_diameter'],
                         __.z1carton['GRID'][iz][4][1] + (__.z1carton['Leng'][iz] / 2) - __._['q_tab_glue_diameter'], ],
                        [0, 'L',
                         __.z1carton['GRID'][iz][2][0] + (__.z1carton['Widt'][iz] / 3) + __._['q_tab_glue_diameter'],
                         __.z1carton['GRID'][iz][4][1] + (__.z1carton['Leng'][iz] / 2), ],
                        [0, 'L', __.z1carton['GRID'][iz][2][0] + __._['q_tab_glue_diameter'],
                         __.z1carton['GRID'][iz][4][1] + (__.z1carton['Leng'][iz] / 2), ],
                        ...
                        [0, 'L', __.z1carton['GRID'][iz][2][0] - __._['q_tab_glue_diameter'],
                         __.z1carton['GRID'][iz][4][1] + (__.z1carton['Leng'][iz] / 2), ],
                        [0, 'L', __.z1carton['GRID'][iz][2][0] - (__._['q_tab_glue_diameter'] * 1.1),
                         __.z1carton['GRID'][iz][4][1] + (__.z1carton['Leng'][iz] / 2), ],
                        [0, 'L', __.z1carton['GRID'][iz][2][0] - (__._['q_tab_glue_diameter'] * 1.1),
                         __.z1carton['GRID'][iz][4][1] + (__.z1carton['Leng'][iz] / 2) - __._['q_tab_glue_diameter'], ],
                        [0, 'L', __.z1carton['GRID'][iz][1][0] + (__._['q_tab_glue_diameter'] * 1.1),
                         __.z1carton['GRID'][iz][4][1] + (__.z1carton['Leng'][iz] / 2) - __._['q_tab_glue_diameter'], ],
                        [0, 'L', __.z1carton['GRID'][iz][1][0] + (__._['q_tab_glue_diameter'] * 1.1),
                         __.z1carton['GRID'][iz][4][1] + (__.z1carton['Leng'][iz] / 2), ],
                        [0, 'L', __.z1carton['GRID'][iz][1][0] + __._['q_tab_glue_diameter'],
                         __.z1carton['GRID'][iz][4][1] + (__.z1carton['Leng'][iz] / 2), ],
            ...
            if __.z0job0['fullcube'] == 'full' and __.z1carton['Hang'][iz] == '1':
                ...
                for qZ in range(len(__._geom_['q_hang_pin'][0])):
                    _softcarton_['common']['hang-tab']['inner'].append([
                        [0, 'M' if qZ == 0 else 'L',
                         (__.z1carton['GRID'][iz][_hangoffset_ + 1][0] + (__.z1carton['Leng'][iz] * 0.5) +
                          __._geom_['q_hang_pin'][0][qZ]),
                         (__.z1carton['GRID'][iz][2][1] - __._['q_hang_tab_height'] + __._['q_hang_pin_margin'] +
                          __._geom_['q_hang_pin'][1][qZ])]
                    ])
                _softcarton_['common']['hang-tab']['inner'].append(
                    [[0, 'z']])  # important! the nesting number of arrays must match the above contours!
            ...
            _fold_ = [
                ...
                [[
                    ...
                    [0x0000],
                    [0, 'M', __.z1carton['GRID'][iz][1][0] + __._['q_tab_glue_fold_reduction'],
                     __.z1carton['GRID'][iz][2][1], ],
                    [0, 'L', __.z1carton['GRID'][iz][1][0] + __._['q_tab_glue_fold_reduction'],
                     __.z1carton['GRID'][iz][4][1], ],
                ], [
                    [0x0018],
                    # test the half-cube only feature by plotting this otherwise theoretical glue crease line only on half-cubes.
                    [0, 'M', __.z1carton['GRID'][iz][5][0] + __._['q_tab_glue_fold_reduction'],
                     __.z1carton['GRID'][iz][2][1], ],
                    [0, 'L', __.z1carton['GRID'][iz][5][0] + __._['q_tab_glue_fold_reduction'],
                     __.z1carton['GRID'][iz][4][1], ],
                ]],
                ['q_fold_base'],
                [[
                ...
                [[  # base hinge 90deg accessable fold
                    ...
                    [0, 'M', __.z1carton['GRID'][iz][2][0],
                     __.z1carton['GRID'][iz][2][1] + __._['q_crease_lid_hinge_outset'], ],
                    [0, 'L', __.z1carton['GRID'][iz][3][0],
                     __.z1carton['GRID'][iz][2][1] + __._['q_crease_lid_hinge_outset'], ],  # lid flap 1
                    [1, 'M', __.z1carton['GRID'][iz][4][0],
                     __.z1carton['GRID'][iz][2][1] + __._['q_crease_lid_hinge_outset'], ],
                    [1, 'L', __.z1carton['GRID'][iz][5][0],
                     __.z1carton['GRID'][iz][2][1] + __._['q_crease_lid_hinge_outset'], ],  # lid flap 2
                ], [
                    [0x2802],
                    [0, 'M', __.z1carton['GRID'][iz][2][0] + __._['q_tab_dust_seam_reduction'],
                     __.z1carton['GRID'][iz][2][1] + __._['q_crease_lid_hinge_outset'], ],
                    ...
                    [0x1002],
                    [1, 'M', __.z1carton['GRID'][iz][5][0],
                     __.z1carton['GRID'][iz][4][1] - __._['q_crease_lid_hinge_outset'], ],
                    [1, 'L', __.z1carton['GRID'][iz][4][0],
                     __.z1carton['GRID'][iz][4][1] - __._['q_crease_lid_hinge_outset'], ],  # base flap 2
                    [0, 'M', __.z1carton['GRID'][iz][3][0],
                     __.z1carton['GRID'][iz][4][1] - __._['q_crease_lid_hinge_outset'], ],
                    [0, 'L', __.z1carton['GRID'][iz][2][0],
                     __.z1carton['GRID'][iz][4][1] - __._['q_crease_lid_hinge_outset'], ],  # base flap 1
                    [0, 'M', __.z1carton['GRID'][iz][2][0], __.z1carton['GRID'][iz][4][1] + 0, ],
                    [0, 'L', __.z1carton['GRID'][iz][1][0], __.z1carton['GRID'][iz][4][1] + 0, ],
                    # full cube lid lower hinge
                ], [
                    [0x3002],
                    [1, 'M', __.z1carton['GRID'][iz][5][0],
                     __.z1carton['GRID'][iz][4][1] - __._['q_crease_lid_hinge_outset'], ],
                    ...
                    [1, 'L', __.z1carton['GRID'][iz][3][0], __.z1carton['GRID'][iz][4][1] + 0, ],
                    # full cube lid lower hinge
                    [0, 'M', __.z1carton['GRID'][iz][3][0],
                     __.z1carton['GRID'][iz][4][1] - __._['q_crease_lid_hinge_outset'], ],
                    [0, 'L', __.z1carton['GRID'][iz][2][0] + __._['q_tab_dust_seam_reduction'],
                ...
                [[  # lid hinge 90deg accessable fold
                    [0x0802],
                    [0, 'M', __.z1carton['GRID'][iz][1][0] + __._['q_tab_lid_flap_line'],
                     __.z1carton['GRID'][iz][1][1] + __._['q_crease_lid_flap_inset'], ],
                    [0, 'L', __.z1carton['GRID'][iz][2][0] - __._['q_tab_lid_flap_line'],
                     __.z1carton['GRID'][iz][1][1] + __._['q_crease_lid_flap_inset'], ],  # lid tab hinge
                ], [
                    [0x2803],
                    [0, 'M', __.z1carton['GRID'][iz][3][0] + __._['q_tab_lid_flap_line'],
                     __.z1carton['GRID'][iz][1][1] + __._['q_crease_lid_flap_inset'], ],
                    [0, 'L', __.z1carton['GRID'][iz][4][0] - __._['q_tab_lid_flap_line'],
                     __.z1carton['GRID'][iz][1][1] + __._['q_crease_lid_flap_inset'], ],  # lid tab hinge
                ], [
                    [0x3003],
                    [0, 'M', __.z1carton['GRID'][iz][4][0] - __._['q_tab_lid_flap_line'],
                     __.z1carton['GRID'][iz][5][1] - __._['q_crease_lid_flap_inset'], ],
                    [0, 'L', __.z1carton['GRID'][iz][3][0] + __._['q_tab_lid_flap_line'],
                     __.z1carton['GRID'][iz][5][1] - __._['q_crease_lid_flap_inset'], ],  # full cube lid tab hinge
                ], [
                    [0x1002],
                    [0, 'M', __.z1carton['GRID'][iz][2][0] - __._['q_tab_lid_flap_line'],
                     __.z1carton['GRID'][iz][5][1] - __._['q_crease_lid_flap_inset'], ],
                    [0, 'L', __.z1carton['GRID'][iz][1][0] + __._['q_tab_lid_flap_line'],
                     __.z1carton['GRID'][iz][5][1] - __._['q_crease_lid_flap_inset'], ],  # full cube lid tab hinge
                ]],
            ]
            ...
            ## Flap open/closed translation
            ##
            #_inx.utils.debug('##[[## ' + __.z0job0['closed'].__str__() + ' ##]]##')
            iter=[0,0,0,0]
            if False: _inx.utils.debug('@@[[@@ ' + iz.__str__() + ' @@]]@@')
            for item_a in [
                [
                    [
                        _softcarton_['cliplock']['inner-flap']['A2i1'],
                        _softcarton_['cliplock']['inner-flap']['A2o1'],
                    ], [
                        _softcarton_['cliplock']['inner-flap']['A2i2'],
                        _softcarton_['cliplock']['inner-flap']['A2o2'],
                    ]
                ], [
                    [
                        _softcarton_['cliplock']['inner-flap']['B2i1'],
                        _softcarton_['cliplock']['inner-flap']['B2o1'],
                    ], [
                        _softcarton_['cliplock']['inner-flap']['B2i2'],
                        _softcarton_['cliplock']['inner-flap']['B2o2'],
                    ]
                ]
            ]:
                iter[0] += 1
                ...
                iter[2] = 0
                iter[3] = 0
                if __.z0job0['closed'][iter[0]-1] == 1 or __.z0job0['closed'][iter[0]-1] == 3:
                    for item_b in item_a:
                        iter[1] += 1
                        iter[2] = 0
                        iter[3] = 0
                        if False: _inx.utils.debug(
                            '@@[[## ' +
                            ( 3 if iter[1] != iter[0] else 4 ).__str__() + ', ' +
                            ( 2 if iter[0] == 1 else 4 ).__str__() + ', ' +
                            iter.__str__() +
                            '##]]@@')
                        for item_c in item_b:
                            iter[2] += 1
                            iter[3] = 0
                            for item_d in item_c:
                                iter[3] += 1
                                if False: _inx.utils.debug('##[[## ' + item_d.__str__() + ' ##]]##')
                                if item_d.__len__()>=2:
                                    bitu = iter[0]==1
                                    bitv = iter[1]==1
                                    bitx = iter[1]!=iter[0]
                                    bity = iter[0]==iter[1]
                                    swpx = ( __.z1carton['GRID'][iz][(2 if bity else 4)][0] - item_d[2] )
                                    swpy = ( __.z1carton['GRID'][iz][(2 if bitu else 4)][1] - item_d[3] )
                                    item_d[2] = (1 if bitv else -1) * swpy + ( __.z1carton['GRID'][iz][(3 if bity else 4)][0]  )
                                    item_d[3] = (1 if bitu != bity else -1) * swpx + ( __.z1carton['GRID'][iz][(1 if bitv else 2) if bitu else (4 if bitv else 5)][1] )
                                    #item_d[2] += (4.5 if bitx else -4.5)
                                    item_d[3] += 0 if bity else (1 if bitv else -1)
            ##
            ...
            _chop_ = [
                ...
                ['q_diagnose'], [
                    ...
                    [
                        ...
                        [0, 'L', __.z1carton['GRID'][iz][1][0] + __._['q_tab_lid_flap_line'],
                         __.z1carton['GRID'][iz][1][1], ],
                        [0, 'L', __.z1carton['GRID'][iz][1][0] + __._['q_tab_lid_flap_line'],
                         __.z1carton['GRID'][iz][1][1] + __._['q_tab_lid_flap_hook'], ],
                        ...
                        [0, 'L', __.z1carton['GRID'][iz][2][0] - __._['q_tab_lid_flap_line'],
                         __.z1carton['GRID'][iz][5][1], ],
                        [0, 'L', __.z1carton['GRID'][iz][2][0] - __._['q_tab_lid_flap_line'],
                         __.z1carton['GRID'][iz][5][1] - __._['q_tab_lid_flap_hook'], ],
                    ...
                    ##------------## Hanging Eyelet
                    _softcarton_['common']['hang-tab']['inner'],
                    # eyelet cutout for a point-of-sale rack mounted hanger
                ...
                if (
                    ...
                    _window_chop.append([
                        ...
                        [0, 'M',
                         ...
                         __.z1carton['Window'][iz]['Curved'][qZ]),
                        ...
                        [0, 'C',
                         __.z1carton['Window'][iz]['centre']['x'][qZ] + (__.z1carton['Window'][iz]['Xi'][qZ] / 2) - (
                                     __.z1carton['Window'][iz]['Curved'][qZ] / 2),
                         __.z1carton['Window'][iz]['centre']['y'][qZ] - (__.z1carton['Window'][iz]['Yi'][qZ] / 2),
                         __.z1carton['Window'][iz]['centre']['x'][qZ] + (__.z1carton['Window'][iz]['Xi'][qZ] / 2),
                         __.z1carton['Window'][iz]['centre']['y'][qZ] - (__.z1carton['Window'][iz]['Yi'][qZ] / 2) + (
                                     __.z1carton['Window'][iz]['Curved'][qZ] / 2),
            ...
            for qZ in range(len(__.z1carton['GridInsert'][iz])):  # (__.z1carton['GridInsert'][iz].buffer_info()[1]):
                ##
                ## insert crease path
                if (__.z1carton['Insert'][iz]['Li'][qZ] > 0 and __.z1carton['Insert'][iz]['Wi'][qZ] > 0 and
                        __.z1carton['Insert'][iz]['Hi'][qZ] > 0):
                    _insert_fold.append([
                        [512], ['q_fold_insert'],
                        ...
                        [0, 'M', __.z1carton['GridInsert'][iz][qZ][0],
                         __.z1carton['GridInsert'][iz][qZ][1] + __.z1carton['Insert'][iz]['Hi'][qZ] +
                         __.z1carton['Insert'][iz]['Wi'][qZ], ],
                        [0, 'L', __.z1carton['GridInsert'][iz][qZ][0] + __.z1carton['Insert'][iz]['Li'][qZ],
                         __.z1carton['GridInsert'][iz][qZ][1] + __.z1carton['Insert'][iz]['Hi'][qZ] +
                         __.z1carton['Insert'][iz]['Wi'][qZ], ],
                        [0, 'M', __.z1carton['GridInsert'][iz][qZ][0],
                         __.z1carton['GridInsert'][iz][qZ][1] + (__.z1carton['Insert'][iz]['Hi'][qZ] * 2) +
                         __.z1carton['Insert'][iz]['Wi'][qZ], ],
                        [0, 'L', __.z1carton['GridInsert'][iz][qZ][0] + __.z1carton['Insert'][iz]['Li'][qZ],
                         __.z1carton['GridInsert'][iz][qZ][1] + (__.z1carton['Insert'][iz]['Hi'][qZ] * 2) +
                         __.z1carton['Insert'][iz]['Wi'][qZ], ],
                    ...
                    _insert_chop.append([
                        ...
                        [0, 'L', __.z1carton['GridInsert'][iz][qZ][0] + __.z1carton['Insert'][iz]['Li'][qZ],
                         __.z1carton['GridInsert'][iz][qZ][1] + (__.z1carton['Insert'][iz]['Hi'][qZ] * 2) + (
                                     __.z1carton['Insert'][iz]['Wi'][qZ] * 2), ],
                        [0, 'L', __.z1carton['GridInsert'][iz][qZ][0] + __.z1carton['Insert'][iz]['Li'][qZ] - __._[
                            'q_tab_glue_taper'],
                         __.z1carton['GridInsert'][iz][qZ][1] + (__.z1carton['Insert'][iz]['Hi'][qZ] * 2) + (
                                     __.z1carton['Insert'][iz]['Wi'][qZ] * 2) + __._['q_tab_glue_diameter'], ],
                ...
                attribs = {
                    ...
                    'cy': str(__.z1carton['GridInsert'][iz][qZ][1] + (__.z1carton['Insert'][iz]['Wi'][qZ] * 0.5) +
                              __.z1carton['Insert'][iz]['Hi'][qZ]),
    ...
    def uffect_1(__, list00):  # 1 piece
        ...
        for iz in range(len(__.z1carton['Enable'])):
            ...
            if (__.z1carton['Enable'][iz] == 'true'):
                ...
                scanstring = 'item-{0:d}'.format(
                    iz)  # We are immediately pruning something. Today it is going to be what was immediately generated prior.
                ...
                for element in __._root_.iter(tag=_x.Element):
                    if element.eid[0:len(scanstring)] == scanstring:  #
                        ...
                        element.getparent().remove(
                            element)  # Prior work is no longer wanted! Remove this pollution from our XML SVG namespace!
                        pass
    ...
    def uffect_3(__, list00):  # Insert
        ...
        yy = (__.z0job0['offset'][qZ][1] * 2) + ((__.z3insert['Hi'][qZ] + __.z3insert['Wi'][qZ]) * 2) + __._[
            'q_tab_glue_diameter']
        __._root_.set('width', str(xx) + "mm")
        __._root_.set('height', str(yy) + "mm")
        __._root_.set('viewBox', '0 0 %.0f %.0f' % (xx, yy))
    ...
    def offect_5(__):  # Outset / Container
        ...
        for qZ in range(len(__.z5outset['GRID'])):
            ...
            for zZ in range(int(__.z5outset['Quantity'][qZ])):
                qZdeep, qZflap = float(__.z5outset['Height'][qZ]), __.z5outset['FlapHeight'][
                    qZ]  # __.z5outset['Wid'][qZ]/2 #__.z1carton['GRID'][7][1]/2
                ...
                sP['61'] = [
                    [1024], ['q_fold_outset'],
                    [1024, 'M', __.z5outset['GRID'][qZ][0] + __.z5outset['Len'][qZ],
                     __.z5outset['GRID'][qZ][1] + qZflap + qZdeeper],
                    [1024, 'L', __.z5outset['GRID'][qZ][0] + __.z5outset['Len'][qZ],
                     __.z5outset['GRID'][qZ][1] + qZflap + qZdeep + qZdeeper],
                    [1024, 'M', __.z5outset['GRID'][qZ][0] + __.z5outset['Len'][qZ] + __.z5outset['Wid'][qZ],
                     __.z5outset['GRID'][qZ][1] + qZflap + qZdeeper],
                    [1024, 'L', __.z5outset['GRID'][qZ][0] + __.z5outset['Len'][qZ] + __.z5outset['Wid'][qZ],
                     __.z5outset['GRID'][qZ][1] + qZflap + qZdeep + qZdeeper],
                    [1024, 'M', __.z5outset['GRID'][qZ][0] + (__.z5outset['Len'][qZ] * 2) + __.z5outset['Wid'][qZ],
                     __.z5outset['GRID'][qZ][1] + qZflap + qZdeeper],
                    [1024, 'L', __.z5outset['GRID'][qZ][0] + (__.z5outset['Len'][qZ] * 2) + __.z5outset['Wid'][qZ],
                     __.z5outset['GRID'][qZ][1] + qZflap + qZdeep + qZdeeper],
                    [1024, 'M', __.z5outset['GRID'][qZ][0] + (__.z5outset['Len'][qZ] + __.z5outset['Wid'][qZ]) * 2,
                     __.z5outset['GRID'][qZ][1] + qZflap + qZdeeper],
                    [1024, 'L', __.z5outset['GRID'][qZ][0] + (__.z5outset['Len'][qZ] + __.z5outset['Wid'][qZ]) * 2,
                     __.z5outset['GRID'][qZ][1] + qZflap + qZdeep + qZdeeper],
                    [1024, 'M', __.z5outset['GRID'][qZ][0] + 0, __.z5outset['GRID'][qZ][1] + qZflap - 1 + qZdeeper],
                    [1024, 'L', __.z5outset['GRID'][qZ][0] + __.z5outset['Len'][qZ],
                     __.z5outset['GRID'][qZ][1] + qZflap - 1 + qZdeeper],
                    [1024, 'M', __.z5outset['GRID'][qZ][0] + __.z5outset['Len'][qZ],
                     __.z5outset['GRID'][qZ][1] + qZflap + 1 + qZdeeper],
                    [1024, 'L', __.z5outset['GRID'][qZ][0] + __.z5outset['Len'][qZ] + __.z5outset['Wid'][qZ],
                     __.z5outset['GRID'][qZ][1] + qZflap + 1 + qZdeeper],
                    ...
                    [1024, 'L', __.z5outset['GRID'][qZ][0] + (__.z5outset['Len'][qZ] + __.z5outset['Wid'][qZ]) * 2,
                     __.z5outset['GRID'][qZ][1] + qZflap + 1 + qZdeeper],
                    [1024, 'M', __.z5outset['GRID'][qZ][0] + 0,
                     __.z5outset['GRID'][qZ][1] + qZflap + qZdeep + 1 + qZdeeper],
                    [1024, 'L', __.z5outset['GRID'][qZ][0] + __.z5outset['Len'][qZ],
                     __.z5outset['GRID'][qZ][1] + qZflap + qZdeep + 1 + qZdeeper],
                    [1024, 'M', __.z5outset['GRID'][qZ][0] + __.z5outset['Len'][qZ],
                     __.z5outset['GRID'][qZ][1] + qZflap + qZdeep - 1 + qZdeeper],
                ...
                sP['72'] = [
                    ...
                    [1024, ' ',
                     __.z5outset['GRID'][qZ][0] + (__.z5outset['Len'][qZ] + __.z5outset['Wid'][qZ]) * 2 - 1.5,
                     __.z5outset['GRID'][qZ][1] + 0 + qZdeeper],
                    [1024, 'L',
                     __.z5outset['GRID'][qZ][0] + (__.z5outset['Len'][qZ] + __.z5outset['Wid'][qZ]) * 2 - 1.5,
                     __.z5outset['GRID'][qZ][1] + qZflap + qZdeeper],
                    [1024, 'L', __.z5outset['GRID'][qZ][0] + (__.z5outset['Len'][qZ] + __.z5outset['Wid'][qZ]) * 2,
                     __.z5outset['GRID'][qZ][1] + qZflap + qZdeeper],
                    [1024, 'L', __.z5outset['GRID'][qZ][0] + 20 + (__.z5outset['Len'][qZ] + __.z5outset['Wid'][qZ]) * 2,
                     __.z5outset['GRID'][qZ][1] + qZflap + 10 + qZdeeper],
                    [1024, 'L', __.z5outset['GRID'][qZ][0] + 20 + (__.z5outset['Len'][qZ] + __.z5outset['Wid'][qZ]) * 2,
                     __.z5outset['GRID'][qZ][1] + qZflap + qZdeep - 10 + qZdeeper],
                    [1024, 'L', __.z5outset['GRID'][qZ][0] + (__.z5outset['Len'][qZ] + __.z5outset['Wid'][qZ]) * 2,
                     __.z5outset['GRID'][qZ][1] + qZflap + qZdeep + qZdeeper],
                    [1024, 'L',
                     __.z5outset['GRID'][qZ][0] + (__.z5outset['Len'][qZ] + __.z5outset['Wid'][qZ]) * 2 - 1.5,
                    ...
                    [1024, 'L',
                     __.z5outset['GRID'][qZ][0] + (__.z5outset['Len'][qZ] + __.z5outset['Wid'][qZ]) * 2 - 1.5,
                     __.z5outset['GRID'][qZ][1] + (qZflap * 2) + qZdeep + qZdeeper],
                ]
                sP['73'] = [
                    [1024], ['q_chop_out_outset'],
                    [1024, ' ',
                     __.z5outset['GRID'][qZ][0] + (__.z5outset['Len'][qZ] * 2) + __.z5outset['Wid'][qZ] + 1.5,
                     __.z5outset['GRID'][qZ][1] + (qZflap * 2) + qZdeep + qZdeeper],
                    [1024, 'L',
                     __.z5outset['GRID'][qZ][0] + (__.z5outset['Len'][qZ] * 2) + __.z5outset['Wid'][qZ] + 1.5,
                     __.z5outset['GRID'][qZ][1] + qZflap + qZdeep + qZdeeper],
                    ...
                    [1024, 'L',
                     __.z5outset['GRID'][qZ][0] + (__.z5outset['Len'][qZ] * 2) + __.z5outset['Wid'][qZ] - 1.5,
                     __.z5outset['GRID'][qZ][1] + (qZflap * 2) + qZdeep + qZdeeper],
                    [1024, 'L', __.z5outset['GRID'][qZ][0] + __.z5outset['Len'][qZ] + __.z5outset['Wid'][qZ] + 1.5,
                     __.z5outset['GRID'][qZ][1] + (qZflap * 2) + qZdeep + qZdeeper],
                    [1024, 'L', __.z5outset['GRID'][qZ][0] + __.z5outset['Len'][qZ] + __.z5outset['Wid'][qZ] + 1.5,
                     __.z5outset['GRID'][qZ][1] + qZflap + qZdeep + qZdeeper],
                    [1024, 'L', __.z5outset['GRID'][qZ][0] + __.z5outset['Len'][qZ] + __.z5outset['Wid'][qZ] - 1.5,
                    ...
                    [1024, 'L', __.z5outset['GRID'][qZ][0] + __.z5outset['Len'][qZ] + __.z5outset['Wid'][qZ] - 1.5,
                     __.z5outset['GRID'][qZ][1] + (qZflap * 2) + qZdeep + qZdeeper],
                    [1024, 'L', __.z5outset['GRID'][qZ][0] + __.z5outset['Len'][qZ] + 1.5,
                     __.z5outset['GRID'][qZ][1] + (qZflap * 2) + qZdeep + qZdeeper],
                    [1024, 'L', __.z5outset['GRID'][qZ][0] + __.z5outset['Len'][qZ] + 1.5,
                     __.z5outset['GRID'][qZ][1] + qZflap + qZdeep + qZdeeper],
                    [1024, 'L', __.z5outset['GRID'][qZ][0] + __.z5outset['Len'][qZ] - 1.5,
                ...
                sP['74'] = [
                    [1024], ['q_chop_out_outset'],
                    [1024, ' ', __.z5outset['GRID'][qZ][0] + 1.5,
                     __.z5outset['GRID'][qZ][1] + (qZflap * 2) + qZdeep + qZdeeper],
                    [1024, 'L', __.z5outset['GRID'][qZ][0] + 1.5,
                     __.z5outset['GRID'][qZ][1] + qZflap + qZdeep + qZdeeper],
                ...
                sP['75'] = [
                    [1024], ['q_chop_out_outset'],
                    [1024, ' ', __.z5outset['GRID'][qZ][0] + __.z5outset['Len'][qZ] - 1.5,
                     __.z5outset['GRID'][qZ][1] + 0 + qZdeeper],
                    [1024, 'L', __.z5outset['GRID'][qZ][0] + __.z5outset['Len'][qZ] - 1.5,
                     __.z5outset['GRID'][qZ][1] + qZflap + qZdeeper],
                    [1024, 'L', __.z5outset['GRID'][qZ][0] + __.z5outset['Len'][qZ] + 1.5,
                ...
                sP['85'] = [
                    ...
                    [1024, 'L', __.z5outset['GRID'][qZ][0] + __.z5outset['Len'][qZ] - 1.5,
                     __.z5outset['GRID'][qZ][1] - qZflap + qZdeeper],
                    [1024, 'M', __.z5outset['GRID'][qZ][0] + __.z5outset['Len'][qZ] + 1.5,
                     __.z5outset['GRID'][qZ][1] + 0 + qZdeeper],
                    [1024, 'L', __.z5outset['GRID'][qZ][0] + __.z5outset['Len'][qZ] + __.z5outset['Wid'][qZ] - 1.5,
                     __.z5outset['GRID'][qZ][1] + 0 + qZdeeper],
                    [1024, 'L', __.z5outset['GRID'][qZ][0] + __.z5outset['Len'][qZ] + __.z5outset['Wid'][qZ] - 1.5,
                    ...
                    [1024, 'L', __.z5outset['GRID'][qZ][0] + __.z5outset['Len'][qZ] + __.z5outset['Wid'][qZ] - 1.5,
                     __.z5outset['GRID'][qZ][1] - qZflap + qZdeeper],
                    [1024, 'M', __.z5outset['GRID'][qZ][0] + __.z5outset['Len'][qZ] + __.z5outset['Wid'][qZ] + 1.5,
                     __.z5outset['GRID'][qZ][1] + 0 + qZdeeper],
                    [1024, 'L',
                     __.z5outset['GRID'][qZ][0] + (__.z5outset['Len'][qZ] * 2) + __.z5outset['Wid'][qZ] - 1.5,
                     __.z5outset['GRID'][qZ][1] + 0 + qZdeeper],
                ...
                if zZ > 0:
                    ...
                    if int(__.z5outset['Quantity'][qZ]) > 1:
                        ...
                        sP['70'] = [sP['72'], sP['73'], sP['74'], sP['75'],
                                    sP['88']]  # 'M'+sP72+'L'+sP73+'L'+sP74+'L'+sP75+'z' # 1/1
                        sP['80'] = []
                        sP['70'][0][2][1] = 'M'
                        sP['70'][1][2][1] = 'L'
                        sP['70'][2][2][1] = 'L'
    ...
    def uffect_5(__, list00):
        ...
        # qZdeeper=((qZflap*2)+qZdeep)*zZ
        # All three .set()s following must be used together to maintain scale!!!
        xx = __.z5outset['GRID'][qZ][0] + ((__.z5outset['Len'][qZ] + __.z5outset['Wid'][qZ]) * 2) + (20) + (
                    __.z0job0['offset'][0][0] * 1)
        yy = __.z5outset['GRID'][qZ][1] + (
                    (__.z5outset['Wid'][qZ] + float(__.z5outset['Height'][qZ])) * int(__.z5outset['Quantity'][qZ])) + (
                         __.z0job0['offset'][0][1] * 1)
        __._root_.set('width', str(xx) + "mm")
        __._root_.set('height', str(yy) + "mm")
        __._root_.set('viewBox', '0 0 %.0f %.0f' % (xx, yy))
        ##https://inkscape.org/forums/extensions/extension-access-children-of-layer/
    ...
    def add_arguments(__, pars):
        ...
        # 'WigIt'
        pars.add_argument('--historyfader01', type=int,
                          help='Transition between current and former drawing via translucency values')
        ...
        pars.add_argument('--q_0all_closed_lidd', type=int, help='')
        pars.add_argument('--q_0all_closed_base', type=int, help='')
        ...
        pars.add_argument('--q_04im_00_pagesize', type=int, help='')
        pars.add_argument('--q_04im_00_pageorient', type=int, help='')
    ...
    def get_arguments(__):
        ...
        __.z0job0 = {
            ...
            'closed': [ __._['q_0all_closed_lidd'], __._['q_0all_closed_base'], ],
        }
        ## Includes:
        ...
        __._stylesheet_ = {
            ...
            'q_chop_inn_tab': {  # tab hitches for gripping onto dust flaps
                ...
                'stroke-width': __._['q_col1_cut2'],  # thin cut line
                'stroke-opacity': __._['q_col1_cut3'],
                # Mark a discernable difference between isolated cuts and the continous contour.
                'fill': 'none',  # Use only to determine shape area.
            ...
            'q_register': {  # calibration markers for combinded printing and plotting
                ...
                # registration lines need to be fairly obvious to both operator and plotter.
            ...
            # diagnostic style
            'q_diagnose': {
                # highlight points of interest, including the major grid we bind our carton cut and crease lines to.
                ...
                'stroke-opacity': __._['q_col1_reg3'],
                # diagnostic lines must not interfere with the viewing of the primary working subject matter.
                'fill': 'none',  # required for closed paths intended for a cutting plotter!
